Public Class Form1
    ...
    Dim qact, q_uncracked, q_cracked, q_max, qst, a, Fy, S, n As Double
    Dim x As Integer
    REM declaring moment variables
    Dim Mu, Ku, um, us, Asm, As_m, As_s, dm, n_m, mkus As Double
    Dim dn As Integer
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        chng1 = "-v0.0 Beta:" & vbCrLf & " *Software released." & vbCrLf & " *Added:" & vbCrLf _
            ...
            & "  -Changed the way shear results are displayed."
